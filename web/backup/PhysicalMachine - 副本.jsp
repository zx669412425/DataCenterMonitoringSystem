...
//-----------------------------------------------------------------------------------------------------------           
      ...
      // alert("当前选项是:2");
		 ...
		 setInterval(myChart.setOption(cpu_option), 30000);
       }
      if(this.value==memoryUsage){
    	  myChart.clear();
      // alert("当前选项是:3");
      	myChart.setOption(memory_option);
		 setInterval(myChart.setOption(memory_option), 30000);
       }   
        },true);
...
//        td.appendChild(butt);
      ...
      //  clic();
		 //setInterval('testResponseBody', 5000);
      ...
      /*  function clic(){
       ...
       for(var i=0;i<bs.length;i++){
        var b = bs[i];
       //b.setAttribute("aaa",i+1);
       b.onclick = function(){
        //var s = confirm("我是"+this.getAttribute("aaa")+"号按钮。");//重新写函数体
       //confirm("虚拟机的名字是"+this.getAttribute("aaa"));
       var ab=2;
       window.location.href='VirtualMachine.jsp?a=1&b='+ab;
       }
        }
       } */
     </script>         
