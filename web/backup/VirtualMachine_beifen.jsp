	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				<li><a href="main.jsp"><i class="fa fa-sitemap"></i> 主界面</a></li>
				<li><a href="PhysicalMachine.jsp?hostId=1"><i
                        ...
                        </ul> --> <a href="VirtualMachine.jsp?vmId=1"><i
						class="fa fa-sitemap"></i> 虚拟机</a> <a href="Load.jsp?"><i
						class="fa fa-sitemap"></i> 负载</a></li>
			</ul>
