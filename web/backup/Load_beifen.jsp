...
<!-- ECharts单文件引入 -->
 ...
 //   			  console.log('id 1 '+data);
    	...
    	return vmName1;
/*    	$.post("${pageContext.request.contextPath}/json/vmName",{id:"1"},
    			function(data){ 
...
<table width="100%" border="2" cellspacing="1" cellpadding="4" bgcolor="#cccccc" class="tabtop13" align="center">
                       ...
                       <tr>
                            <th class="btbg font-center titfont" background-color="#ff0000">高负载</th>
                      </tr>
                                <tr>
...
<table width="100%" border="2" cellspacing="1" cellpadding="4" bgcolor="#cccccc" class="tabtop13" align="center">
                       <tr>
                            <th class="btbg font-center titfont">低负载</th>
                      </tr>
                                <tr>
                       <td class="btbg font-center titfont"><script> document.write(hostHighName[0]);</script></td>
                               </tr>
                       ...
                       <td class="btbg font-center titfont"><script> document.write(hostHighName[0]);</script></td>
                               ...
                               <tr>
                       <td class="btbg font-pcenter titfont"><script> document.write(hostHighName[0]);</script></td>
                               </tr>
              </table>
                ...
                <!-- /. ROW  -->
		           ...
		           <table width="100%" border="2" cellspacing="1" cellpadding="4" bgcolor="#cccccc" class="tabtop13" align="center">
                       ...
                       <tr>
                            <th class="btbg font-center titfont" background-color="#ff0000"  colspan="5">高负载</th>
                      </tr>
                                <tr>
                       ...
                       <td class="btbg font-center titfont"> 高负载占比 </td>					   
                                ...
                                <tr>
                       <td class="btbg font-center titfont"><script> document.write(hostHighName[0]);</script> </td>
                       <td class="btbg font-center titfont"><script> document.write(vmHighName[0]);</script> </td>
                       ...
                       <td class="btbg font-center titfont"><script> document.write(vmHighName[1]);</script> </td>	
                       <td class="btbg font-center titfont"><script> document.write(vmHighLoad[1]);</script> </td>	   
                               </tr>
                               <tr>
                       <td class="btbg font-center titfont"><script> document.write(hostHighName[2]);</script> </td>
                       <td class="btbg font-center titfont"><script> document.write(vmHighName[2]);</script> </td>
                       <td class="btbg font-center titfont"><script> document.write(vmHighLoad[2]);</script> </td>
                               </tr>
                               <tr>
                       <td class="btbg font-center titfont"><script> document.write(hostHighName[3]);</script> </td>
                       <td class="btbg font-center titfont"><script> document.write(vmHighName[3]);</script> </td>
                       <td class="btbg font-center titfont"><script> document.write(vmHighLoad[3]);</script> </td>
                               </tr>
                               <tr>
                       <td class="btbg font-center titfont"><script> document.write(hostHighName[4]);</script> </td>
                       <td class="btbg font-center titfont"><script> document.write(vmHighName[4]);</script> </td>
		           ...
		           <table width="100%" border="2" cellspacing="1" cellpadding="4" bgcolor="#cccccc" class="tabtop13" align="center">
                       ...
                       <tr>
                            <th class="btbg font-center titfont" background-color="#ff0000"  colspan="5">低负载</th>
                      </tr>
                                <tr>
                       <td class="btbg font-center titfont"> 物理机名字 </td>	
                       <td class="btbg font-center titfont"> 虚拟机名字 </td>
