...
<body>
	...
	var vmNetUsage1 = new Array();

	function getVmNetUsage1(){
		$.ajax({
			type:"get",
	...
	getVmNetUsage1();
	//console.log(getVmNetUsage1());

    var singleVmName1  ;
    function getSingleVmName1(){
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath}/json/singleVmName",
            data:"id="+vm,
            async:false,
            datatype:"json",
            contentType: 'application/json;charset=utf-8',
            success:function(data){
                console.log(data+"+singleVmName1");
                singleVmName1 = data;
            },
        });
        return singleVmName1;
    }
    singleVmName1=getSingleVmName1();
    console.log(singleVmName1);
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li>
					...
					<a href="#"><i	class="fa fa-sitemap"></i> 虚拟机</a>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-12 col-xs-12">
						<div
							...
							<div class="panel-footer back-footer-green" id="cpuPanel">CPU利用率
								<script>
									if(cpuUsage>30){
					...
					<div style="height: 400px" ,width="400px">
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<span class="pull-right" id="vmName">
									虚机名：
									<script>
										document.write(singleVmName1);
										//console.log(vmName);
									</script>
								</span>
							</div>
